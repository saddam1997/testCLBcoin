    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("ClubCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  ClubCoin [options]                     " + "\n" +
                  "  ClubCoin [options] <command> [params]  " + _("Send command to -server or ClubCoin") + "\n" +
                  "  ClubCoin [options] help                " + _("List commands") + "\n" +
                  "  ClubCoin [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: ClubCoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: ClubCoin.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the ClubCoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. ClubCoin is probably already running."), strDataDir.c_str()));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("ClubCoin version %s (%s)\n", FormatFullVersion().c_str(), CLIENT_DATE.c_str());
