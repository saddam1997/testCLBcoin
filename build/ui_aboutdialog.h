...
"Copyright &copy; 2011-YYYY The ClubCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About ClubCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>ClubCoin</b> version", 0));
